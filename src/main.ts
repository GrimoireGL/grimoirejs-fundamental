...
export default () => {
    GrimoireInterface.register(async () => {
        ...
        GrimoireInterface.registerComponent(_$ns("ImageTexture"), ImageTextureComponent);
        GrimoireInterface.registerComponent(_$ns("VideoTexture"), VideoTextureComponent);
