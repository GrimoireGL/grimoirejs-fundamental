...
export default class Geometry {
  ...
  public addIndex(indexName: string, bufferOrInstanceCount: Buffer | number[] | BufferSource | number, bufferOrTopology: Buffer | number[] | BufferSource | number, offsetOrTopology: number, countOrOffset: number |null = null, typeOrCount = 0, type?: number): void {
  ...
  public clone(): Geometry {
    ...
    geometry.buffers = this.buffers.concat();
