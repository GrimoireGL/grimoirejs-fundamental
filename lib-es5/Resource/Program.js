...
var Program = function (_ResourceBase) {
    ...
    function Program(gl) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Program).call(this, gl));
    ...
    _createClass(Program, [{
        ...
        value: function update(shaders) {
            ...
            shaders.forEach(function (shader) {
                _this2.gl.attachShader(_this2.program, shader);
            });
        ...
        value: function bindAttribLocation(index, name) {
            this.gl.bindAttribLocation(this.program, index, name);
        }
    }, {
        key: "destroy",
        value: function destroy() {
            _get(Object.getPrototypeOf(Program.prototype), "destroy", this).call(this);
