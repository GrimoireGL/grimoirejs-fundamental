...
import IMorphParameter from "./MorphParameter";
...
export default class MorphGeometry extends Geometry {
   ...
   * no document
   */
  public morphParameters: { [semantics: string]: IMorphParameter[] } = {};
  ...
  private _morphBaseAttribute: { [semantics: string]: IMorphParameter } = {};

  /**
   * no document
   * @param semantics
   * @param morphParameters
   */
  public addMorphAttribute(semantics: string, morphParameters: IMorphParameter[]): void {
