...
export default () => {
  GrimoireInterface.register(async() => {
    ...
    GrimoireInterface.registerNode("goml", [CanvasInitializerComponent, LoopManagerComponent, AssetLoadingManagerComponent, GeometryRegistoryComponent, RendererManagerComponent, FullscreenComponent]);
    GrimoireInterface.registerNode("scene", [SceneComponent]);
    GrimoireInterface.registerNode("object", [TransformComponent]);
    GrimoireInterface.registerNode("camera", [CameraComponent], { position: "0,0,10" }, "object");
    GrimoireInterface.registerNode("mesh", [MaterialContainerComponent, MeshRendererComponent], null, "object");
    ...
    GrimoireInterface.registerNode("import-material", [MaterialImporterComponent]);
    ...
    GrimoireInterface.registerNode("render-scene", [RenderSceneComponent, RenderHitArea], { material: null });
    GrimoireInterface.registerNode("render-quad", [MaterialContainerComponent, RenderQuadComponent], { material: null });
    GrimoireInterface.registerNode("rendering-target", [RenderingTargetComponent]);
